    ...
    <div className="min-h-screen bg-titan-black overflow-x-hidden">
      ...
      <div className="pt-40 pb-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="font-cormorant text-5xl md:text-7xl font-bold text-white mt-3 mb-6">Чертежи</h1>
          <p className="font-ibm text-base text-white/40 max-w-xl leading-relaxed">
            Раздел находится в разработке. Здесь будут опубликованы технические чертежи ТИТАН М1.
          </p>
